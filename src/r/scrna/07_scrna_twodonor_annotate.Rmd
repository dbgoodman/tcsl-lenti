...
cluster_name_dt <- data.table(Subtype=names(cluster_name_map), subtype_lbl=unlist(cluster_name_map))
cluster_name_dt <- data.table(Subtype=names(all_colors), color=unlist(all_colors))[
...
combined_gene_heatmap_boxed_horiz
```
