...
cd4_genes <- list(
  'STIM-IFNG'= c(
    "GZMA", "CD2", "CD74", "HLA-DRA", "IFNG", "ITGB2",
  ...
  'TH2'= c(
    "IL5", "IL13", "GATA3", "IL4"),
  'MEM-CD29'= c(
    "S100A4", "KLRB1", "ITGB1", "ITGA4", "HOPX",
    "NKG7", "NEAT1", "CXCR3", "KLRG1", "CCR5"))

cd8_genes <-list(
  "NAIVE-CD7"= c(
    "IFITM2", "VIM", "STMN1", "HMGN2", "STIM1", "CD7", "IFITM1", "TCF7","LEF1","CD27"),
  "MEM-CD29"= c(
    "ITGA1", "ITGB2", "CXCR3","S100A4", "ANXA1", "KLRG1", "HOPX","KLRB1"),
  "STIM-IFNG"= c(
  ...
  "STIM-OXPHOS"= c(
    "FKBP4", "HSPD1", "HSP90AB1",
    "C1QBP", "EIF5A", "HSPH1", "MD-ND3", "SRM",
    "IL2RA"),
  "STIM-INACT"= c(
...
plots$fig_assembled <- plot_grid(plot_grid(fig_A, plot_grid(fig_C, fig_E, ncol=2, labels=c('C','D')), ncol=1, rel_heights=c(1,1.5), labels=c('A','')), plot_grid(fig_B, fig_D+coord_fixed() +theme(legend.position='bottom',
    legend.key.height=unit(0.4, 'lines'),
    legend.key.width=unit(2, 'lines')), ncol=1, rel_heights=c(1.7,1), labels=c('B','E')), ncol=2, rel_widths=c(2,1))

plots$fig_assembled_2 <- plot_grid(plot_grid(fig_A, plot_grid(fig_, fig_E, ncol=2, labels=c('C','D')), ncol=1, rel_heights=c(1,1.5), labels=c('A','')), plot_grid(fig_B, fig_D+coord_fixed() +theme(legend.position='bottom',
    legend.key.height=unit(0.4, 'lines'),
    legend.key.width=unit(2, 'lines')), ncol=1, rel_heights=c(1.7,1), labels=c('B','E')), ncol=2, rel_widths=c(2,1))
