...
make_citeseq_dt <- function(obj_subset) {
  return(data.table(cbind(t(obj_subset@assays$ADT@data), obj_subset@meta.data))[car != 'K_only'])
}
...
citeseq_density_2d <- function(obj_subset, x_axis, x_cutoff, y_axis, y_cutoff, title=paste0(x_axis,' vs ',y_axis)) {
