...
cd8_seg_1 <- cd8_cbind_dt[day != 33][, c('day', 'car', 'donor', 'k562', 't_type', 'PC1', 'PC2', 'PC3')]
...
cd8_seg_2 <- cd8_cbind_dt[day != 0][, c('day', 'car', 'donor', 'k562', 't_type', 'PC1', 'PC2', 'PC3')]
colnames(cd8_seg_2)[colnames(cd8_seg_2) %in% c("day", "PC1", "PC2", "PC3")] <- c("day_b", "PC1_b", "PC2_b", "PC3_b")

cd8_seg_dt <- merge(cd8_seg_1, cd8_seg_2, by=c('day_b','donor','car','k562','t_type'))
