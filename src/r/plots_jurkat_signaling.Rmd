...
#DAN LOOK HERE LOOK HERE LOOK HERE

#to make a data table with stimulation of each normalized to untransduced for that day and that line
norm.signaling.dt <- signaling.dt[, list(
  norm.diff= combo_mcherry_percent[Stimulation=="+"] / combo_mcherry_percent[Stimulation=='none']),
  by=c('CAR','Line','Hours')]
