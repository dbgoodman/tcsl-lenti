...
fig4_compiled_v3<- plot_grid(
  ...
  plot_grid(
    ...
    plot_grid(
      plot_grid(
        as_ggplot(get_legend(plot_killing_cd8_log+guides(col = guide_legend(nrow = 3))))+theme(plot.margin = margin(50,50,50,50, 'pt')),
        NULL, ncol=2, rel_widths=c(0.3, 0.7)),
      in_vitro_killing,
      ncol=1,
      rel_heights=c(1,5),
      labels=c('A','B')
