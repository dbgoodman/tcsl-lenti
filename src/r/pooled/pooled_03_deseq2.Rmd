...
interbin_volcano <- ggplot(data.dt[
  ...
  labs(x='Cumulative Proliferation,\nLog2 Fold Change from Mean', y='-log10(P-value)') + 
  theme_minimal() +
  theme(panel.border=element_rect(fill=NA))
  
ggsave(here::here('..','figs','pooled','interbin_volcano.pdf'), interbin_volcano,
       height=4, width=7)
```
...
prolif_4v8 <- ggplot(
    dcast(data.dt[
  k.type == 'pos' & ((ref_set == 'baseline' & test_set == 'ABCD' & assay != 'CTV1') | (ref_set == 'CD' & test_set == 'A' & assay == 'CTV1'))& k.type == 'pos'], 
  ...
  theme_minimal() + 
  labs(x='CD4', y='CD8', title='Proliferation, CD4 vs CD8') +
  theme(panel.border=element_rect(fill=NA))
