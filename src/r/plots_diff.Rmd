...
plot_by_day <- function(diff_mean_dt, title) {
  return(ggplot(diff_mean_dt[, car := factor(car, levels=c(car_order, 'untrans'))]) + 
      ...
      facet_grid(car~k562+type+donor) + 
...
plot_by_day(cd62_cd45ra_diff_dt[k562=='cd19+'], 'CD62L vs CD45RA differentiation') |
  plot_by_day(cd62_cd45ro_diff_dt[k562=='cd19+'], 'CD62L vs CD45RO differentiation') |
