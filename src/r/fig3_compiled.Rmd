...
total_combined[CAR.align == 'TNR8', CAR.align := 'CD30']
total_combined[CAR.align == 'HAVCR1b', CAR.align := 'TIM1']

cast_metrics <- dcast(
  total_combined[!((grepl('[ABCD]+\\.[ABCD]+',comparison) | grepl('rlog',comparison)) & assay == 'CTV3')],
  CAR.align ~ group + assay + k.type + t.type + comparison, 
...
ggsave(here::here('..','figs','compiled','figS2.pdf'), figS2_compiled,
       height=9.25*fig_scaling, width=8.5*fig_scaling, useDingbats=FALSE)
```
