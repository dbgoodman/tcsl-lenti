...
all_plots <- function(umap_fcs_dt, umap_cluster_dt, cell_type, dendro=T) {
  ...
  plot_grid(umap_plot, umap_heatmap, var_heatmap, clusters_by_day, cars_by_cluster, tbl, labels = "AUTO", align = "h", nrow=6, rel_heights = c(3/12, 3/12, 1/12, 1/12, 3/12, 1/12))
} 
